...
export function initPrism(containerId, options = {}) {
...
// Auto initializer
function startPrism() {
  if (document.getElementById("prism-container")) {
    initPrism("prism-container", {
      animationType: 'rotate',
      timeScale: 0.5,
      height: 3.5,
      baseWidth: 5.5,
...
if (document.readyState === 'loading') {
  document.addEventListener("DOMContentLoaded", startPrism);
} else {
  startPrism();
}
